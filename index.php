...
<body>
        ...
        <div id="About" class="page">
            <div class="pageListHeader">
                <div class="pageHeader">
                    <h1>About Me</h1>
                    <p>I am Florian Solé. I was born in Tournai in Belgium, but i moved to the Netherlands when i was around 1
                        year old and still live there to this day.</p>
                </div>
            ...
            <div class="pageList">
                <div class="pageText">
                    ...
                    <p>I am currently studying Application Developer at Scalda in Vlissingen. Before this I studied HBO-ICT at
                        ...
                        requirements to pass on to the next year. Despite all that, I'd say that I have found my passion in
                        programming and am surely planning on continuing this.</p>
                </div>
                <div class="aboutImageContainer"><img class="aboutImage" src="assets\logo-Scalda.jpg" width="140" height="100"></div>
            </div>
            <div class="pageList">
                <div class="pageText">
                    <h4>Hobbies</h4>
                    <p>In my free time you'll probably find me behind my computer playing some games. That does not mean I don't
                        do sports though. I am the goalkeeper for my
    ...
    <div id="Projects" class="page">
        ...
        <ul>
            <li>
                <h2><a style="color:white" href="https://sleepy-harbor-96591.herokuapp.com/" target="_blank">original portfolio</a></h2>
                <div class="pageList">
                    <div class="pageText">
                        <p>As the first project I am listing here, you would probably think that this is the project that
                            I'm most proud of. But that is not the case here.
                            This project was my first ever github project. This project was meant as a portfolio assignement
                            when I was still studying at the HZ university.
                            For how much experience I had when I started this project, I think that it is a pretty good
                            website. The website is currently in all kinds of disrepair,
                            and is defenitely not a good website in it's current state, but I am still proud of what i
                            achived with only 1 or 2 months of any coding experience.
                        </p>
                    </div>
                    <div class="pplImageContainer">
                        <img class="pplImage" src="assets\portfolioOriginal.jpg" width="500" height="300">
                    </div>
                </div>
            </li>
            <li style="text-align:right; direction:rtl">
                <h2><a style="color:white;" href="https://flonumbers.github.io/basisschoolproject/" target="_blank">Bassisschoolproject</a></h2>
                <div class="pageList2">
                    <div class="pplImageContainer">
                        <img class="pplImage" src="assets\basisschoolProject.jpg" width="500" height="300">
                    </div>
                    <div class="pageText">
                        <p>This one is another project I made for an assignement at the HZ university. This was a group
                            project that we had to make for a primary school.
                            It had to be some kind of small game that had to do with a specific course they taught at
                            that school. We chose history. The whole game is written in typescript
                            and is made in such a way that you never have to reload the page. You can even save your
                            progress if you don't delete your cookies.
                            This is a project that I am personally very proud of. Yes the website is still riddled with
                            bugs and quirks that need to be ironed out, but I think
                ...
                <div class="pageList">
                    <div class="pageText">
                        <p>So this very website you're in right now is also a school assignement, but this one is a school
                            assignement for my current school, Scalda.
                            I will be keeping this website up to date with new projects and thing I'm learning, so everyone
                            who's interested can take a peek.
                        </p>
                    </div>
                    <div class="pplImageContainer">
                        <img class="pplImage" src="assets\portfolioHuidig.jpg" width="500" height="300">
                    </div>
                </div>
            </li>
        </ul>
